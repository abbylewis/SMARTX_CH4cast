...
LUE<- data[,13] #growing season LUE computed for each site using measured GPP in gC per umol  
...
#CONSTANTS
#LUE_mean <- theta[6] #0.9 #computed a mean across each growing season (g C MJ-1)
...
APAR_2 <- fPAR_2*PAR_2 #umol m-2 d-1
