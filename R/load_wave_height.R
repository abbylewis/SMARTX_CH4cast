load_wave_height <- function(forecast_date = Sys.Date(),
                             forecast_days = 16) {
  ...
  url_base <- "https://marine-api.open-meteo.com/v1/marine"
  url_path <- glue::glue("?latitude={lat}&longitude={long}&daily=wave_height_max,swell_wave_direction_dominant&start_date={start_date}&end_date={end_date}")
